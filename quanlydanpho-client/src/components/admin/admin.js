    ...
    <div id='profile-v1'>
      <MDBContainer fluid>
        <MDBCard className='p-2 mb-5'>
          <MDBRow>
            <MDBCol lg='6' md='12'>
              <MDBSelect className='colorful-select w-10 float-left dropdown-primary mx-2  hidden-md-down'>
            ...
            <MDBCol lg="3" md="12" className="d-flex justify-content-end align-items-center">
        ...
        <MDBCard narrow className='pb-3'>
          <MDBView
            cascade
            className='gradient-card-header height blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center'
          >
